                ...
                .authorizeHttpRequests(
                        auth -> {
                            auth
                                    ...
                                    .requestMatchers("/adsweb/api/v1/patient/**").hasAuthority("Office Manager")
                                    .requestMatchers("/adsweb/api/v1/dentist/**").hasAuthority("Office Manager")
                                    .requestMatchers("/adsweb/api/v1/appointment/**").hasAuthority("Office Manager")
                                    .requestMatchers("/adsweb/api/v1/surgerylocation/**").hasAuthority("Office Manager")
                                    .requestMatchers("/adsweb/api/v1/address/**").hasAuthority("Office Manager")
                                    .requestMatchers("/adsweb/api/v1/appointments/patient/**").hasAuthority("Patient")
                                    .requestMatchers("/adsweb/api/v1/appointments/dentist/**").hasAuthority("Dentist");
